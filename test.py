...
smoothening = 1  # Adjust this value as needed for smoothness
...
def move_mouse(index_finger_tip):
    ...
    if index_finger_tip is not None:
        ...
        target_y = int(index_finger_tip.y * screen_height)  # Full height, no division by 2

        # Apply smoothing for gradual movement
